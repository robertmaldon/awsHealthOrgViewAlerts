...
10. In *Account numbers* enter in a comma-separated list of account numbers you want to deploy to (i.e. 123456789012,987654321987) OR select *Deploy stacks in organizational units* and enter in the OU identifier of the AWS Organizational Unit you want to deploy to (i.e. ou-123a-bc345de). **Click** the region you want to deploy the resouces to. Scroll to the bottom and **click** the *checkbox* and **click** *Create stack*.
